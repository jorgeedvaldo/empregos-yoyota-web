...
<body>
    <div x-data="{ state: false }">
      ...
      <section>
        <div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gray-50 p-6 sm:py-12">
            <div class="job-card flex w-full my-4 max-w-6xl flex-col justify-between gap-3 rounded-md bg-white px-8 py-8 shadow-xl shadow-gray-100 sm:flex-row sm:items-center hover:shadow-lg hover:shadow-gray-400 transition duration-300 ease-in-out">
                <div>
                  <span class="text-sm text-gray-700">Kwame Oil and Gas</span>
                  <h3 class="mt-px font-bold">Engenheiro Backend Full Stack Sênior</h3>
                  <p class="text-slate-600">O QHSE Group Transocean está focado em ser o empregador preferido para a indústria de perfuração. Nos desafiamos todos os dias para impulsionar o desempenho da empresa...</p>
                ...
                <div>
                  <button class="flex items-center gap-1 rounded-md bg-gray-900 px-4 py-2 font-medium text-white hover:bg-gray-800 transition duration-300 ease-in-out">
                    Detalhes
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="block space-x-0 lg:flex lg:space-x-6">
        ...
        <div class="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
          ...
          <div class="p-4 pl-0">
            ...
            <a href="#" class="inline-block py-2 px-4 rounded text-white bg-gray-900 mt-2 ml-auto"> Le mais </a>
          </div>
        </div>
...
<footer class="w-full min-h-screen flex items-center justify-center bg-black mt-10 pt-10">
    <div class="md:w-2/3 w-full px-4 text-white flex flex-col mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
        ...
        <div class="flex mt-8 flex-col md:flex-row md:justify-between">
            <p class="w-full md:w-2/3 text-gray-400">Não recrutamos ninguém, nossa missão é divulgar as vagas do Jornal de Angola e de outras fontes seguras.</p>
        </div>
        <div class="flex flex-col">
            <div class="flex mt-24 mb-12 flex-row justify-between">
                ...
                <a class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Oportunidades</a>
                <a class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Artigos</a>
                <a class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Termos e Condições</a>
